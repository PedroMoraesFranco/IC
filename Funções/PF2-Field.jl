...
function get_intensidade_laser_one_point_escalar(Position_Sensor::Array, E₀::Number, ω₀::Number, k::Number)
...
function get_intensidade_laser_escalar(Sensores::Array, k::Number, E₀::Number, ω₀::Number)
...
function get_intensidade_espalhada_escalar(sensores, k, E₀, ω₀, Γ₀, β, r)
...
function get_intensidade_laser_vetorial(Sensores, k, E₀, ω₀)
    Nsensor = size(Sensores,1);
    I_laser = zeros(Nsensor)
    for i in 1:Nsensor
...
function get_intensidade_espalhada_vetorial(sensores, k, E₀, ω₀, Γ₀, β, r)
